...
- Task 8 implementation commit: `cea70263d4042b7fed191465105a0c3c112c1a0f` (`feat(content): replace media revisions atomically`); deterministic 40/40 and named Journey B 1/1.
- Task 8 scoped review: CHANGES REQUIRED. T8-R01 late async preparation/unmount can leak staged bytes/retainers and race committing cleanup; T8-R02 replacement can overwrite concurrent metadata edits that do not bump revision; T8-R03 Journey B overclaims QMD fullscreen/new rendered bytes; T8-R04 replace Cancel/Escape evidence is absent; T8-R05 governing summary text contradicts promoted rows. Bounded correction authorized; Task 9 remains gated.
- Task 8 fix commit: `5590657466d26248d2686a3700c37fec5e77b161` (`fix(content): close media replacement lifecycle gaps`); focused 17/17, exact 42/42, named Journey B 1/1.
- Task 8 docs correction: `140996634fd8050a2deb4ce9dad0cbf735e41a72` (`docs(audit): correct Task 8 security status summary`).
- Task 8 final review: T8-R01 through T8-R05 RESOLVED; spec APPROVED; code APPROVED; evidence/documentation APPROVED. SCM-S08/R02 Passing; SCM-C08 media-replace branch Passing and overall Partial for later data-source relink. Task 8 complete at `140996634fd8050a2deb4ce9dad0cbf735e41a72`.
- Task 9 implementation commit: `fbcd93f7e1102696307079ca73d5e1e6277a19d7` (`feat(qmd): add responsive media placement controls`); deterministic 35/35 and named Journey C 1/1.
- Task 9 scoped review: CHANGES REQUIRED. T9-R01 selected placement replacement uses canonical-text `indexOf`, which can mutate an identical inert/code literal or fail angle-bracket destinations; T9-R02 Change picker does not receive or restore keyboard focus and evidence overstates focus/context. Geometry/request authority approved; SCM-C06/R03 remain blocked pending correction. Task 10 remains gated.
- Task 9 focus/identity fix: `9843ed4bbba9cad024f3e95317f9e9151b580a5a` (`fix(qmd): preserve exact placement identity and focus`); parser 8/8, mounted 15/15, exact 38/38, Journey C 1/1. T9-R02 resolved; T9-R01 remained open due parallel scanner/reference correspondence.
- Task 9 canonical span fix: `93a5fd68031e70cd2a682fcc51e8d56a75e3f58a` (`fix(qmd): derive placement spans from canonical parser`); parser 9/9, mounted 16/16, exact 40/40, Journey C 1/1.
- Task 9 final review: T9-R01/R02 RESOLVED; spec/code/UI/evidence APPROVED. SCM-S11/C06/C07/R03 Passing. Task 9 complete at `93a5fd68031e70cd2a682fcc51e8d56a75e3f58a`.
- Task 10 implementation commit: `8e7c9811a1749a069ed89a1e0252982092288efe` (`feat(content): manage CSV add and chart selection`); deterministic 116/116 and named Journey D 1/1.
- Task 10 scoped review: CHANGES REQUIRED. T10-R01 current uploaded CSV staging is discarded before source-change confirmation; cancelling can leave the retained selection without its draft authority or pair it with a pending candidate. Existing managed CSV mounted selection is also not exercised. Bounded correction authorized; Task 11 remains gated.
- Task 10 correction commit: `8abfd36` (`fix(content): preserve CSV draft through source confirmation`); focused 71/71, exact seven-file selection 119/119, named Journey D Chromium 1/1 with mounted existing-managed-CSV selection.
- Task 10 final review: APPROVED. T10-R01 resolved; lifecycle, evidence, and scope checks pass with no Task 11 behavior introduced. Task 10 complete at `8abfd36`.
- Task 11: BASE `3c9c68232c05e177f0825e54a8125d53505ff43c`; brief `.superpowers/sdd/2026-08-25-source-content-manager-and-qmd-reusable-media/task-11-brief.md`; fresh implementer owns the bounded CSV direct-replacement/Journey E slice.
- Task 11 implementation commit: `b8087c8f7d2181649c6cf435b0fd6d5ac67f7a7b` (`feat(content): block incompatible CSV replacement`); exact deterministic 67/67 and named Journey E 1/1 at 1440×900/1024×768.
- Task 11 rulings: authorized the exact `ContentDetail` coordinator pass-through and `BuildWorkspace`/`SourceContentWorkspace` close-before-navigation transport because existing wrappers dropped the already-authorized coordinator/selection path; cost is three minimal transport owners, with no new navigation or transaction architecture.
- Task 11 review finding T11-R01: the purported non-temporal fixture shifted its observation range and effective-profile temporal bindings could publish silently before Task 12.
- Task 11 correction commits: `1bbfeef2cbb378c71e25bc1ff074b173be02f27f` (`fix(content): defer temporal CSV replacement review`) and `5a8e48e99cfef79081b860d7c10937a12c37594c` (`fix(content): honor inferred temporal CSV bindings`); final exact gate 70/70. Temporal-changing candidates defer with a typed non-structural state and cannot publish; no Task 12 metadata/impact behavior entered.
- Task 11 final review: APPROVED. SCM-S09/R05 Passing; CSV structural branch of SCM-C08 Passing and row overall Partial. Task 11 complete at `5a8e48e99cfef79081b860d7c10937a12c37594c`.
- Task 12: BASE `a074e1c`; brief `.superpowers/sdd/2026-08-25-source-content-manager-and-qmd-reusable-media/task-12-brief.md`; fresh implementer owns CSV temporal impacts/durable review status and Journey F.
- Task 12 rulings: authorized `ContentActionDialog`/`DataSourceDetail` plus the focused dialog test because the accepted warning/confirm UI was otherwise unreachable; reconciled six independently reproduced stale chrono expectations test-only with no playback reducer production edit.
- Task 12 implementation commit: `db0853cd047e7c97730868cda42a6888d0ac6d86` (`feat(content): persist CSV temporal review impacts`); exact deterministic 110/110 and named Journey F 1/1 at Build/Present 1440×900.
- Task 12 scoped review: CHANGES_REQUIRED on T12-R01 because temporal impacts matched wrapper placement IDs while Chrono/Scene compositions reference nested chart IDs.
- Task 12 correction commit: `20a36966780a022e2cf55ff3461f19de85b68ece` (`fix(content): match temporal impacts by chart identity`); RED 15/17, focused GREEN 17/17, exact Task 12 GREEN 112/112. Direct-use breadcrumbs retain placement IDs; impact contexts use nested chart IDs.
- Task 12 final review: APPROVED. SCM-S10/R06 Passing; CSV temporal branch of SCM-C08 Passing and row overall Partial. Task 12 complete at `20a36966780a022e2cf55ff3461f19de85b68ece`.
- Task 13: BASE `72084fb`; brief `.superpowers/sdd/2026-08-25-source-content-manager-and-qmd-reusable-media/task-13-brief.md`; fresh implementer owns GeoJSON manager/selector/shared Build map budget and Journey I.
- Task 13 ruling: authorized `ChartWizardV3` as the verified six-stage GeoJSON draft/commit owner; tentative unlisted source-entry owner edits were removed and publication stayed in planned `contentDraftTransaction`.
- Task 13 implementation commit: `30e12edecba367e0806a2a0c01f049795749708e` (`feat(content): manage GeoJSON with shared map budget`); exact deterministic 119/119 and named Journey I 1/1 at 1440×900/1024×768.
...
- Task 13 pre-release boundary correction (2026-08-27): the historical T13-R01 close-disposal ruling is superseded for chart authoring. Chart Close/Escape suspends the complete staged CSV/GeoJSON authority and UI; explicit discard, source supersession/reset, validation failure, and true unmount retain cleanup ownership. Focused deterministic owners are 6/6 GeoJSON and 5/5 chart lifecycle; corrected Journeys D/I are each 1/1 Chromium GREEN.
...
- Task 16 review correction: root cause was runtime source/static failures remaining only in `dataSourceStates`; no derived content overlay reached manager/QMD consumers. Focused RED added missing/corrupt static-asset and failed linked CSV assertions. `loadDashboardConfig` and progressive loading now derive non-serialized `runtimeContentHealth`, and `DashboardRenderer` applies it only to runtime content consumers. Focused GREEN: 36/36 (`staticPanelPersistence`, `progressiveDashboardLoad`, `contentHealth`, `dashboardAppV3`). Journey H fixture unchanged, so it was not rerun.
- Task 16 re-review correction: unused/QMD-only local media had no static-image source and therefore missed the runtime overlay. RED asserted a missing manifest yields an overlay while the stored item remains `ready`; GREEN moves authored-asset inspection to every local media item and lets static-image source state reuse it. Focused 9/9 then 36/36 (`staticPanelPersistence`, `contentHealth`, `progressiveDashboardLoad`, `dashboardAppV3`); Journey H fixture contract unchanged, not rerun.
...
- Task 15 scoped review: CHANGES_REQUIRED on R15-01 recovery-required partial dashboard publication after asset commit failure and R15-02 package validation trusting declared raster MIME/dimensions without the existing structural parser.
- Task 15 correction candidate: R15-01/R15-02 focused RED **7/10** import plus **5/8** package/raster → GREEN **10/10** and **20/20**. Import now commits assets before replacement and restores exact asset/dashboard snapshots on commit/replace/rebase failure; package validation consumes the exported existing intrinsic raster inspector.
- Corrected exact Task 15 selection: **53/54**, PS-04 sole failure on the unchanged generated client; corrected Journey G **1/1 passing** at 1.3 m test / 1.4 m total. No build, `dist`, Task 16, full suite, or release suite.
- Correction subject: `fix(content): make V5 package import atomic and intrinsic`; awaiting affected-boundary re-review.
- Task 15 final affected finding: zero-payload imports skipped the dashboard snapshot/restore boundary and could retain a replaced dashboard after renderer rebase failure.
- Final affected correction: focused import transaction RED **10/11** → GREEN **11/11**; an asset-free valid V5 import restores the exact prior dashboard after injected rebase failure with no asset mutation.
- Final exact Task 15 selection: **54/55**, with PS-04 the sole unchanged generated-client residual. Journey G was not rerun because its successful live path does not exercise this injected compensation branch.
- Final correction subject: `fix(content): compensate asset-free package imports`; awaiting affected-boundary re-review. No build, `dist`, Task 16, full suite, or release suite.
