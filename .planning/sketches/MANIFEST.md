...
| 022 | Image authoring | How should Image creation and editing separate durable assets and saved transforms from transient viewer interactions? | Approved by master; design only | A — Canvas + Transform Inspector (accepted) | static content, Image, crop, rotation, assets, accessibility |
| 023 | Static panels in Build and View | How should saved Free-text and Image panels preserve canonical composition while exposing authoring chrome only in Build? | Approved by master; design only | A — Content-led Canonical Panels (accepted) | static content, Build, View, fullscreen, responsive |
