...
export const ICON_LANGUAGE_VERSION="1.1.0";
export const ICON_TOKENS=Object.freeze({base:"#08224A",accentBase:"#19D3C5",accentOnLight:"#0D746D",accentOnDark:"#32DED1",danger:"#D64545",success:"#2AA876"});
...
// The imported inventory is intentionally compact. Keep refinements in one
// readable metadata layer before the public registry is constructed.
const INTERACTION_REFINEMENTS = Object.freeze({
  "fullscreen.select.1": Object.freeze({
    note: "Accent check; number offset upper-left",
  }),
  "fullscreen.select.2": Object.freeze({
    note: "Accent check; number offset upper-left",
  }),
  "fullscreen.select.3": Object.freeze({
    note: "Accent check; number offset upper-left",
  }),
  "fullscreen.select.4": Object.freeze({
    note: "Accent check; maximum selection reached",
  }),
  "shell.install": Object.freeze({ glyphId: "install", renderMode: "icon", status: "live" }),
  "shell.global-panel-colors": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.report-an-issue": Object.freeze({
    glyphId: "reportIssue",
    renderMode: "icon",
  }),
  "playback.choose-synchronized-time": Object.freeze({
    glyphId: "timeSelect",
    renderMode: "icon",
  }),
  "playback.playback-speed": Object.freeze({
    glyphId: null,
    label: "1×",
    tooltip: "Playback speed",
    note: "Runtime value uses {speed}×",
  }),
  "fullscreen.close-all-fullscreen-charts": Object.freeze({ glyphId: "closeAll" }),
  "fullscreen.selection-count": Object.freeze({
    glyphId: "selectionCount",
    renderMode: "icon",
    note: "Numeric status remains dynamic",
  }),
  "panel.hold-ctrl-while-scrolling-to-zoom": Object.freeze({ glyphId: null }),
  "editor.save-changes": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.reset-changes": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.save-edits": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.reset-edits": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.import": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.export": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.apply-background": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.save-background": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.reset-background": Object.freeze({ renderMode: "icon", status: "live" }),
  "shell.start-section": Object.freeze({ renderMode: "icon", status: "live" }),
  "wizard.create-chart": Object.freeze({ renderMode: "icon", status: "live" }),
  "wizard.enter-data-manually": Object.freeze({ renderMode: "icon", status: "live" }),
  "wizard.view-source-csv": Object.freeze({ renderMode: "icon", status: "live" }),
  "wizard.add-row": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.add-measurement": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.add-filter": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.add-factor": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.add-color": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.use-default-colors": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.apply-to-source-sharing-charts": Object.freeze({ renderMode: "icon", status: "live" }),
  "editor.cancel": Object.freeze({ renderMode: "icon", status: "live" }),
});
...
export const LIVE_INTERACTION_IDS = Object.freeze([
  ...
  "shell.icon-accent",
  "shell.apply-background",
  "shell.save-background",
  ...
  "fullscreen.enter-multi-fullscreen",
  "layout.solo",
  "layout.side-by-side",
  ...
  "wizard.create-chart",
  "wizard.enter-data-manually",
  "wizard.view-source-csv",
  "wizard.remove-data-source",
  "wizard.add-row",
  "wizard.remove-row",
  "editor.tab.data",
  ...
  "editor.tab.map",
  "editor.tab.timeline",
  "editor.tab.collection",
  "editor.tab.interactions",
  "editor.tab.advanced",
  "editor.add-measurement",
  "editor.add-filter",
  "editor.add-factor",
  "editor.add-color",
  "editor.remove-measurement",
  "editor.use-default-colors",
  "editor.apply-to-source-sharing-charts",
  "editor.pick-color-from-dashboard",
  "editor.save-changes",
  "editor.reset-changes",
  "editor.cancel",
  "collection.mode.fixed-grid",
  "collection.mode.scrollable-grid",
  "collection.mode.auto-carousel",
...
for (const surface of inventory) {
  for (const entry of surface.entries ?? []) {
    ...
    const refinedEntry = { ...entry, ...INTERACTION_REFINEMENTS[id] };
    records[id] = Object.freeze({
      ...refinedEntry,
      id,
      status: refinedEntry.status === "reference" || REFERENCE_INTERACTION_IDS.has(id)
        ? "reference"
...
records["shell.icon-accent"] = Object.freeze({
  id: "shell.icon-accent",
  glyphId: "palette",
  label: "Icon accent",
  tooltip: "Icon accent",
  renderMode: "icon",
  ...
  status: "live",
  confirmation: "none",
  note: "Sets the dashboard-wide secondary icon accent",
});
  ...
  Object.freeze({
    ...
    ...(entries ? {
      interactionIds: Object.freeze([
        ...
        ...(surface.id === "shell" ? ["shell.icon-accent"] : []),
      ]),
    } : {}),
  })
)), Object.freeze({
...
export function validateIconCatalog() {
  ...
  for (const [id, interaction] of Object.entries(INTERACTIONS)) {
    ...
    if (
      (interaction.renderMode === "icon" && interaction.glyphId === null)
      || (interaction.glyphId !== null && !ICON_GLYPHS[interaction.glyphId])
    ) {
      errors.push(`Unknown glyph for ${id}`);
    }
