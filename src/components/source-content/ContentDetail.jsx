...
export default function ContentDetail({ item, contentDraftCoordinator, datasetProfile, geoData, onRename, ...managerProps }) {
  ...
  return <DataSourceDetail item={item} contentDraftCoordinator={contentDraftCoordinator} datasetProfile={datasetProfile} geoData={geoData} onRename={onRename} {...managerProps} />;
}
