...
- The 280 px structure rail lists scenario, pages, sections, panels, and Chrono Groups. The center is the live dashboard canvas. The 336 px inspector contains Content, Data, Chart, Interaction, and Layout sections for the selected item.
