...
- Build and Present are unavailable below 1024px; View mobile design is out of scope; Audience remains a separate large-display surface.
...
- Modify: `src/components/app-shell/PhoneModeNotice.jsx`

**Interfaces:**
- Consumes the initial audit's concrete surface findings after Tasks 2–3 remove shared causes.
- Produces compact Build/View/Present desktop composition and the hard `<1024px` Build/Present gate.
