...
| IM-08 | Image | Focus order and drag/nudge/numeric equivalence | Complete crop keyboard-only then pointer | 1440×900, 1024×768; 200% zoom | Focus/action/geometry evidence | Held / not started | Held / not started | Accepted requirement; not implemented |
...
| IM-10 | Image/Build-View | Zoom/pan bounds, reset, names, surface capability | Tab to View controls; exercise; fullscreen and repeat | Small cell; fullscreen; keyboard; fit modes | Focus + interaction + geometry | Held / not started | Held / not started | Accepted requirement; not implemented |
...
| PS-07 | Build-View/Audience | Surface→interaction mapping, keyboard active controls, zero Audience controls | Open both fullscreen; Image zoom/pan/reset; inspect Audience | Fullscreen; keyboard; 16:9 | Control inventory + interaction | Held / not started | Held / not started | Accepted requirement; not implemented |
